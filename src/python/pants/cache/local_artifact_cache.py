...
class LocalArtifactCache(BaseLocalArtifactCache):
  ...
  def __init__(self, artifact_root, cache_root, compression):
    ...
    """
    BaseLocalArtifactCache.__init__(self, artifact_root, compression)
  ...
  def try_insert(self, cache_key, paths):
    with self.insert_paths(cache_key, paths) as stored:
      return True
...
class TempLocalArtifactCache(BaseLocalArtifactCache):
  ...
  def __init__(self, artifact_root):
    BaseLocalArtifactCache.__init__(self, artifact_root, compression=None)
